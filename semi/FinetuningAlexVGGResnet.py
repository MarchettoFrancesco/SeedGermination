...
ARCHITECTURE = 'alexnet'  # 'custom', 'alexnet', 'vgg16', 'resnet50'
PRETRAINED = True  # Usa pesi pre-trained dove possibile

# Paths dinamici basati su ARCHITECTURE per evitare sovrascritture
MODEL_SAVE_PATH = f"/home/francescomarchetto/semi/seed_germination_model_{ARCHITECTURE}.pth"
REPORT_PATH = f"model_evaluation_report_{ARCHITECTURE}.md"
...
def train_and_evaluate(paths, labels, epochs=EPOCHS, batch_size=BATCH_SIZE, model_save_path=MODEL_SAVE_PATH, report_path=REPORT_PATH):
    ...
    plot_save_path = os.path.join(PLOTS_DIR, f"plots_{ARCHITECTURE}.png")
...
if __name__ == "__main__":
    ...
    # histories = {}
    # for arch in ['custom', 'alexnet', 'vgg16', 'resnet50']:
